...
//        beeperControl.beepForMinute(latch);
...
//        beeperControl.stopTasks();
//        beeperControl.stopScheduler();
        priceGenerator.stopTasks();
        priceGenerator.stopScheduler();
        LOG.info("PortfolioMain...print instrument prices");
        instrumentPrices.forEach(instrument -> {
            LOG.info("...instrument price for id {} = {}",
                    instrument.getInstrumentId(),
                    instrument.getPrice());
        });
        LOG.info("/PortfolioMain");
    }
